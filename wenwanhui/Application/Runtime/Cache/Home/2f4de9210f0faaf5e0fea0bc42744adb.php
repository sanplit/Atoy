...
<html>
	<head>
		...
		<title><?php echo ($title); ?>--产品列表</title>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
					...
					<div class="row-fluid">
						...
						<?php if(is_array($pro_list)): foreach($pro_list as $key=>$pro): ?><div class="row-fluid">
								<form action="/Home/Cart/addCart" method="post">
									<div class="col-md-6">
										<div class="row-fluid">
											<input type="hidden" name="pid" value="<?php echo ($pro["pid"]); ?>">
											<input type="hidden" name="img" value="<?php echo ($pro["pic"]); ?>">
											...
											<input type="hidden" name="count" value="<?php echo ($pro["count"]); ?>">
