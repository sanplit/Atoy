...
<head>
    ...
    <title><?php echo ($title); ?>--产品搜索</title>
                ...
                <div class="">
                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group form-group-lg">
                            <div class="col-sm-10">
                                <input ng-model="sea"  class="form-control" type="text" id="formSearch" placeholder="搜索关键字">
                            </div>
                            <label class="col-sm-2 control-label" for="formSearch"></label>
                        </div>
