            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($vip_list)): foreach($vip_list as $key=>$vip): ?><tr>
                                <td><?php echo ($vip["uid"]); ?></td>
                                <td><?php echo ($vip["username"]); ?></td>
                                <td><?php echo ($vip["email"]); ?></td>
                                <td><?php echo ($vip["phone"]); ?></td>
                                <td><?php echo ($vip["sign"]); ?></td>
                                <td><?php echo ($vip["frist_date"]); ?></td>
                                <td><?php echo ($vip["last_date"]); ?></td>
                                <td>
                                    <a href="/Admin/User/user_del/uid/<?php echo ($vip["uid"]); ?>">
                                        <button type="button" class="btn btn-danger">会员删除</button>
                                    </a>
                                </td>
