                        ...
                        <div class="col-md-6">
                            <form role="form" class="form-inline" action="" method="post">
                                <div class="form-group"><br>
                                    <label for="uid" class="col-sm-3 control-label">用户ID</label>
                                    <div class="col-sm-9">
                                        <input name="uid" type="text" onkeyup='this.value=this.value.replace(/\D/gi,"")' class="form-control" id="uid"
                                               placeholder="请输入用户ID（必填）" required>
                                    </div>
                                </div><br><br>
                                <div class="form-group">
                                    <label for="pid" class="col-sm-3 control-label">商品ID</label>
                                    <div class="col-sm-9">
                                        <input name="pid" type="text" onkeyup='this.value=this.value.replace(/\D/gi,"")' class="form-control" id="pid"
                                               placeholder="请输入商品ID（必填）" required>
                                    </div>
                                </div><br><br>
                                <div class="form-group">
                                    <label for="count" class="col-sm-3 control-label">订单数</label>
                                    <div class="col-sm-9">
                                        <input name="count" type="text" onkeyup='this.value=this.value.replace(/\D/gi,"")' class="form-control" id="count"
                                               placeholder="请输入订单数（默认为1）" required>
                                    </div>
                                </div><br><br>
                                <div class="form-group">
                                    <label for="mark" class="col-sm-3 control-label">备&nbsp;注</label>
                                    <div class="col-sm-9">
                                        <textarea name="mark" type="text" class="form-control" id="mark"
                                                  placeholder="">
                                        </textarea>
                                    </div>
                                </div><br><br>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button name="order_add" type="submit" class="btn btn-success">添加</button>&nbsp;&nbsp;&nbsp;&nbsp;
